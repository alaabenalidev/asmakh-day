...
import {Gamepad2, Grid3X3, RefreshCw, Star, Trophy} from "lucide-react";
              ...
              hsl(45 90% 50%) 315deg 360deg
                ...
                >
                    {prizes.map((prize, i) => (
                        ...
                        >
              <span
                  className="text-xs md:text-sm font-bold text-white absolute top-8 transform -rotate-90 whitespace-nowrap max-w-[80px] truncate">
                {prize}
              </span>
                        </div>
                    ))}
                ...
                {/* Center */}
                <div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 md:w-20 md:h-20 rounded-full bg-card shadow-lg flex items-center justify-center">
...
const games = [
    {
        id: "spin",
        name: "Spin to Win",
        backgroundColor: "bg-gradient-to-br from-[#6243b5] to-coral-dark",
    ...
    },
    {
        id: "flip",
        name: "Memory Match",
        backgroundColor: "bg-gradient-to-br from-[#4e61af] to-coral-dark",
    ...
    },
    {
        id: "quiz",
        name: "Quick Quiz",
        backgroundColor: "bg-gradient-to-br from-[#3677b6] to-coral-dark",
    ...
    },
    {
        id: "sudoku",
        name: "Sudoku",
        backgroundColor: "bg-gradient-to-br from-[#149ca9] to-coral-dark",
                        ...
                        >
                            {games.map((game, index) => (
                                <motion.div
                                    ...
                                    className={`${game.backgroundColor} text-primary-foreground card-game cursor-pointer group`}
                                    onClick={() => setActiveGame(game.id)}
                                >
                                    <div className="flex items-center gap-4 mb-4">
                                        <div
                                            className="w-14 h-14 rounded-2xl bg-secondary-foreground/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    ...
                                    <Button
                                        variant="accent"
                                        className="bg-[#505081] w-full group-hover:scale-105 transition-transform"
                                    >
                                        Play Now
                                    </Button>
                                </motion.div>
