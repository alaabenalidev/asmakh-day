  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground px-8 py-6 text-lg font-semibold shadow-lg hover:shadow-xl hover:-translate-y-1 hover:scale-105",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-lg hover:-translate-y-0.5",
        game: "bg-secondary text-secondary-foreground px-6 py-4 font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 border-b-4 border-teal-dark active:border-b-0 active:translate-y-1",
      },
      size: {
