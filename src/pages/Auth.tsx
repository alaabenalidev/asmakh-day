...
const Auth = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (mode === "login") {
            ...
            // submitRegistration(userData).then((data) => {
            //     console.log(data);
            // }).catch((error) => {
            //     console.log(error);
            // })
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div
                className="absolute bottom-20 right-20 w-24 h-24 rounded bg-accent/10 -rotate-6 animate-float-delayed"/>
            ...
            >
                ...
                <div className="bg-card rounded-lg shadow-2xl border border-border overflow-hidden">
                    ...
                    <div className="p-8">
                        <div className="text-center mb-8">
                            <div
                                className="w-20 h-20 rounded bg-secondary/20 flex items-center justify-center mx-auto mb-4">
                                {mode === "login" ? (
